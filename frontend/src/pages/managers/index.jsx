                            ...
                            <Card>
                                <CardBody>
                                    <MainTable
                                        meta={meta}
                                        data={data}
                                        handlePageChange={loadAllManagers}
                                        columns={[
                                            { label: "Name", field: "name" },
                                            { label: "Manager ID", field: "member_id" },
                                            { label: "Phone", field: "contact_num" },
                                            { label: "Joined Date", field: "joindate" },
                                            { label: "Department", field: "department" },
                                        ]}
                                        actions={[
                                            { button: <VieweButton />, path: "/dashboard/manager/view/" },
                                            { button: <EditButton />, path: "/dashboard/manager/edit/" },
                                            { button: <DeleteButton />, path: "managers/delete/" },
                                        ]}
                                    />
                                </CardBody>
                            </Card>
                            ...
                            <div id="progrss-wizard" className="twitter-bs-wizard">
                                    ...
                                    <TabPane tabId={1}>
                                        <AvForm className="form-horizontal" >
                                            ...
                                            <Row>
                                                <Col lg="6">
                                                    <FormGroup>
                                                        <Label for="manager-phoneno">Phone</Label>
                                                        <AvField
                                                            type="text"
                                                            className="form-control"
                                                            id="manager-phoneno"
                                    ...
                                    <TabPane tabId={4}>
                                        <div className="row justify-content-center">
                                            <Row className="px-5 py-3">
                                                ...
                                                <Col lg="6">
                                                    <Row><Label className="d-inline-flex mb-2 "> Manger ID : <p className="mx-2 mb-0 fw-light">{userState.member_id}</p></Label></Row>
                                ...
                                <ul className="pager wizard twitter-bs-wizard-pager-link">
                                    ...
                                    >
                                        <Button
                                            onClick={() => {
                                                Admin.createManagers(userState)
                                                    .then((result) => {
                                                        setIsAlertOpen(true);
                                                        loadAllManagers(null);
                                                        getmngrcount();
